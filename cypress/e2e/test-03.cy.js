describe("Demo Blaze Tests - Phones test 2", () => {
  it("Login and place order - Test #3", () => {
    // Here just copied pasted steps from test # 2 that I was going to modify but I did not have enough time to do it
